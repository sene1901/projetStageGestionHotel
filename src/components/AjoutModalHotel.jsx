...
const AjoutHotelModal = ({ onClose }) => {
  ...
  const validate = () => {
    ...
    if (!form.telephone.trim())
      e.telephone = "Téléphone obligatoire";
      ...
      <div className="relative bg-white w-full max-w-3xl rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="border-2 border-dashed rounded-lg h-32 flex flex-col items-center justify-center text-gray-400 cursor-pointer">
